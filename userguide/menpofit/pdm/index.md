...
```
<center>
  <img src="instance_similarity.png" alt="instance_similarity">
</center>
...
```
<center>
  <img src="instance_pca.png" alt="instance_pca">
</center>
...
```python
shape_model.from_vector_inplace([100., -300., 0., 0., 140., -100., 15., 5.])
shape_model.target.view(render_axes=False);
```
